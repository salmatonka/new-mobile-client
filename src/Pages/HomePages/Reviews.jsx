  ...
  return (
    ...
    <div className="bg-gradient-to-tr to-purple-200 from-cyan-200 w-5/6 mx-auto rounded-lg shadow-2xl py-16 sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        ...
        <div className="grid gap-10 mx-auto lg:grid-cols-2 lg:max-w-screen-lg">
            <div className="grid sm:grid-cols-3  bg-gradient-to-tr to-purple-200 from-cyan-200 rounded-lg shadow-2xl ">
                <div className="relative w-full h-48 max-h-full rounded shadow sm:h-auto">
                    <img
                        className="absolute object-cover w-full h-full rounded"
                        src="https://www.gsmarena.com.bd/images/reviews/thumb/Oppo-A17-Review.jpg"
                        alt="Person"
                    />
                </div>
            ...
            <div className="grid sm:grid-cols-3 bg-gradient-to-tr to-purple-200 from-cyan-200 rounded-lg shadow-2xl">
                <div className="relative w-full h-48 max-h-full rounded shadow sm:h-auto">
                    <img
                        className="absolute object-cover w-full h-full rounded"
                        src="https://www.gsmarena.com.bd/images/reviews/thumb/Samsung-Galaxy-Note-20-Ultra-5G.jpg"
                        alt="Person"
                    />
                </div>
                <div className="flex flex-col justify-center mt-5 sm:mt-0 sm:p-5 sm:col-span-2">
            ...
            <div className="grid sm:grid-cols-3 bg-gradient-to-tr to-purple-200 from-cyan-200 rounded-lg shadow-2xl">
                <div className="relative w-full h-48 max-h-full rounded shadow sm:h-auto">
                    <img
                        className="absolute object-cover w-full h-full rounded"
                        src="https://www.gsmarena.com.bd/images/news/thumb/Vivo-y-series-new-smartphone-y22.jpg"
                        alt="Person"
                    />
                </div>
                <div className="flex flex-col justify-center mt-5 sm:mt-0 sm:p-5 sm:col-span-2">
            ...
            <div className="grid sm:grid-cols-3 bg-gradient-to-tr to-purple-200 from-cyan-200 rounded-lg shadow-2xl">
                <div className="relative w-full h-48 max-h-full rounded shadow sm:h-auto">
                    <img
                        className="absolute object-cover w-full h-full rounded"
                        src="https://www.gsmarena.com.bd/images/news/thumb/The-a-to-z-of-galaxy-unpacked-2023.jpg"
                        alt="Person"
                    />
                </div>
                <div className="flex flex-col justify-center mt-5 sm:mt-0 sm:p-5 sm:col-span-2">
