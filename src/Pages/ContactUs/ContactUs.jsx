  ...
  return (
    ...
    <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
      <div className="py-6 md:py-0 md:px-6">
        <h1 className="text-4xl font-bold">mMarket.com</h1>
      ...
      <form noValidate="" className="flex flex-col py-6 space-y-6 md:py-0 md:px-6">
        ...
        <button type="button" className="self-center px-8 py-3 text-lg rounded focus:ring hover:ring focus:ring-opacity-75 bg-gradient-to-tr to-purple-300 from-cyan-200">Submit</button>
      </form>
    </div>
  </section>
  )
