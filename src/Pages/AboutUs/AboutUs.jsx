...
const AboutUs = () => {
    ...
    return (
        <div className=' min-h-screen '>
            <div className="p-5 mx-auto sm:p-10 md:p-10 bg-primary shadow-md text-gray-800">

                <h3 className='text-center text-2xl font-bold pt-0 pb-14 '>ABOUT GLOBAL BRAND ESHOP</h3>
                ...
                <div className="flex flex-col max-w-3xl mx-auto overflow-hidden rounded">
                    ...
                    <div className="p-6 pb-12 m-4 mx-auto -mt-16 space-y-6 lg:max-w-2xl sm:px-10
                     sm:mx-12 lg:rounded-md bg-secondary text-gray-200">
