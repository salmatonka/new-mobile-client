...
const LogIn = () => {
	...
	return (
		<div className='flex justify-center pt-32 pb-28 bg-gradient-to-tr to-purple-100 from-cyan-100'>
			<div className="w-full max-w-md p-4 bg-gradient-to-tr to-purple-200 from-cyan-200 rounded-md shadow sm:p-8  dark:text-gray-100">
				<h2 className="mb-3 text-3xl font-semibold text-center">Login to your account</h2>
				<p className="text-sm text-center dark:text-gray-400">New to mMarket.com? Create new account
					<a href="/signUp" rel="noopener noreferrer" className="focus:underline hover:underline text-sky-500 ml-2"> Sign up here</a>
				</p>
				...
				<form onSubmit={handleSubmit} novalidate="" action="" className="space-y-8">
					...
					<input type="submit" value='Sign Up' className="w-full px-8 py-3 font-semibold rounded-md bg-violet-400 dark:text-gray-900" />
